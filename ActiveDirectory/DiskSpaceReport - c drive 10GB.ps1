<#
    ...
    Instructions:
        1. Update $computers with server list. 1 per line.
        2. Update $reportPath as needed.
        3. Update $percentCritical as needed. (anything with less free space than this number will be on the report)
    
    Notes:
        This is a disk space report script to identify disk space for servers. It also reports any C:/ Drives that have < 10GB free for those servers who's drives are smaller than 100GB's.
